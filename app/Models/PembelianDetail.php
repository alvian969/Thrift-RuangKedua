...
class PembelianDetail extends Model
{
  ...
  protected $fillable = ['pembelian_detail_pembelian_id', 'pembelian_detail_pakaian_id', 'pembelian_detail_nama_pakaian', 'pembelian_detail_jumlah', 'pembelian_detail_total_harga'];
